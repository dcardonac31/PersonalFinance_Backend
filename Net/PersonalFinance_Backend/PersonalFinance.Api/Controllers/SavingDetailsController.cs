...
namespace PersonalFinance.Api.Controllers
{
    ...
    [ApiController]
    public class SavingDetailsController : ControllerBase
    {
        private readonly ILogger<SavingDetailsController> _logger;
        private readonly ISavingDetailService _service;
        private readonly IBrowserDetector _browserDetector;

        public SavingDetailsController(ILogger<SavingDetailsController> logger, ISavingDetailService service, IBrowserDetector browserDetector)
        {
            _logger = logger;
            _service = service;
