...
namespace PersonalFinance.Api.Controllers
{
    ...
    public class ThirdPartiesController : ControllerBase
    {
        ...
        public ThirdPartiesController(ILogger<ThirdPartiesController> logger, IThirdPartyService service, IBrowserDetector browserDetector)
        {
            _logger = logger;
            _service = service;
        ...
        [ProducesResponseType(typeof(ResponseService<ThirdPartyDto>), (int)HttpStatusCode.OK)]
        public async Task<IActionResult> GetByIdAsync(int id)
        {
            ...
            var response = new ResponseService<ThirdPartyDto>
            {
                Status = existResult,
        ...
        [ProducesResponseType(typeof(ResponseService<IEnumerable<ThirdPartyDto>>), (int)HttpStatusCode.OK)]
        public async Task<IActionResult> GetAllAsync(int? page, int? limit)
        {
            ...
            var resultDtos = result as ThirdPartyDto[] ?? result.ToArray();

            var response = new ResponseService<IEnumerable<ThirdPartyDto>>
            {
        ...
        [Produces(MediaTypeNames.Application.Json, Type = typeof(ThirdPartyModel))]
        public IActionResult Post([FromBody] ThirdPartyModel request)
        {
            _logger.LogInformation(nameof(Post));

            var objRequest = Mapper.Map<ThirdPartyDto>(request);
        ...
        [Produces(MediaTypeNames.Application.Json, Type = typeof(ThirdPartyModel))]
        public async Task<IActionResult> PutAsync(int id, [FromBody] ThirdPartyModel request)
        {
