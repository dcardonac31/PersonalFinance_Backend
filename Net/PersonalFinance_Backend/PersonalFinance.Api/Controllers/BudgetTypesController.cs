...
namespace PersonalFinance.Api.Controllers
{
    ...
    public class BudgetTypesController : ControllerBase
    {
        ...
        private readonly ILogger<BudgetTypesController> _logger;
        private readonly IBudgetTypeService _service;
        private readonly IBrowserDetector _browserDetector;


        public BudgetTypesController(ILogger<BudgetTypesController> logger, IBudgetTypeService service, IBrowserDetector browserDetector)
        {
            _logger = logger;
            _service = service;
        ...
        [ProducesResponseType(typeof(ResponseService<BudgetTypeDto>), (int)HttpStatusCode.OK)]
        public async Task<IActionResult> GetByIdAsync(int id)
        {
            ...
            var response = new ResponseService<BudgetTypeDto>
            {
                Status = existResult,
        ...
        [ProducesResponseType(typeof(ResponseService<IEnumerable<BudgetTypeDto>>), (int)HttpStatusCode.OK)]
        public async Task<IActionResult> GetAllAsync(int? page, int? limit)
        {
            ...
            var resultDtos = result as BudgetTypeDto[] ?? result.ToArray();

            var response = new ResponseService<IEnumerable<BudgetTypeDto>>
            {
        ...
        [Produces(MediaTypeNames.Application.Json, Type = typeof(BudgetTypeModel))]
        public IActionResult Post([FromBody] BudgetTypeModel request)
        {
            _logger.LogInformation(nameof(Post));

            var objRequest = Mapper.Map<BudgetTypeDto>(request);
        ...
        [Produces(MediaTypeNames.Application.Json, Type = typeof(BudgetTypeModel))]
        public async Task<IActionResult> PutAsync(int id, [FromBody] BudgetTypeModel request)
        {
