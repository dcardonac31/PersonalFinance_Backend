...
namespace PersonalFinance.Api.Controllers
{
    ...
    public class DebtDetailsController : ControllerBase
    {
        ...
        private readonly IDebtDetailService _service;
        private readonly IBrowserDetector _browserDetector;

        public DebtDetailsController(ILogger<DebtDetailsController> logger, IDebtDetailService service, IBrowserDetector browserDetector)
        {
            _logger = logger;
            _service = service;
        ...
        [ProducesResponseType(typeof(ResponseService<DebtDetailDto>), (int)HttpStatusCode.OK)]
        public async Task<IActionResult> GetByIdAsync(int id)
        {
            ...
            var response = new ResponseService<DebtDetailDto>
            {
                Status = existResult,
        ...
        [ProducesResponseType(typeof(ResponseService<IEnumerable<DebtDetailDto>>), (int)HttpStatusCode.OK)]
        public async Task<IActionResult> GetAllAsync(int? page, int? limit)
        {
            ...
            var resultDtos = result as DebtDetailDto[] ?? result.ToArray();

            var response = new ResponseService<IEnumerable<DebtDetailDto>>
            {
        ...
        [Produces(MediaTypeNames.Application.Json, Type = typeof(DebtDetailModel))]
        public IActionResult Post([FromBody] DebtDetailModel request)
        {
            _logger.LogInformation(nameof(Post));

            var objRequest = Mapper.Map<DebtDetailDto>(request);
        ...
        [Produces(MediaTypeNames.Application.Json, Type = typeof(DebtDetailModel))]
        public async Task<IActionResult> PutAsync(int id, [FromBody] DebtDetailModel request)
        {
