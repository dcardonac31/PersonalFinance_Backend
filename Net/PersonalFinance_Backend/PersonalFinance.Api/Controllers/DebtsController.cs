...
namespace PersonalFinance.Api.Controllers
{
    ...
    public class DebtsController : ControllerBase
    {
        ...
        public DebtsController(ILogger<DebtsController> logger, IDebtService service, IBrowserDetector browserDetector)
        {
            _logger = logger;
            _service = service;
        ...
        [ProducesResponseType(typeof(ResponseService<DebtDto>), (int)HttpStatusCode.OK)]
        public async Task<IActionResult> GetByIdAsync(int id)
        {
            ...
            var response = new ResponseService<DebtDto>
            {
                Status = existResult,
        ...
        [ProducesResponseType(typeof(ResponseService<IEnumerable<DebtDto>>), (int)HttpStatusCode.OK)]
        public async Task<IActionResult> GetAllAsync(int? page, int? limit)
        {
            ...
            var resultDtos = result as DebtDto[] ?? result.ToArray();

            var response = new ResponseService<IEnumerable<DebtDto>>
            {
        ...
        [Produces(MediaTypeNames.Application.Json, Type = typeof(DebtModel))]
        public IActionResult Post([FromBody] DebtModel request)
        {
            _logger.LogInformation(nameof(Post));

            var objRequest = Mapper.Map<DebtDto>(request);
        ...
        [Produces(MediaTypeNames.Application.Json, Type = typeof(DebtModel))]
        public async Task<IActionResult> PutAsync(int id, [FromBody] DebtModel request)
        {
