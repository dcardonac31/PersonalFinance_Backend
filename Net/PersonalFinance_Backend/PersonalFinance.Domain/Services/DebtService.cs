...
namespace PersonalFinance.Domain.Services
{
    public class DebtService : IDebtService
    {
        ...
        public DebtService(IRepository<Debt> repository)
        {
        ...
        public async Task<IEnumerable<DebtDto>> GetAllAsync(int page, int limit, string orderBy, bool ascending = true)
        {
        ...
        public (bool status, int id) Post(DebtDto entity)
        {
            var obj = Mapper.Map<Debt>(entity);
            var result = _repository.Insert(obj);
            return (result, obj.Id);
        }
        public async Task<bool> PutAsync(int id, DebtDto entity)
        {
